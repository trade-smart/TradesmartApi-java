...
public class NorenExampleApp {
    ...
    public static void main(String[] args) {
        ...
        //for UAT
        NorenApiJava api = new com.noren.javaapi.NorenApiJava("https://kambala-uat.tradesmartonline.in/NorenWClientTP/");
        //for live
        //NorenApiJava api = new com.noren.javaapi.NorenApiJava("https://noren-trade.tradesmartonline.in/NorenWClientTP/");

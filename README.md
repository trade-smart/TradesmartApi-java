...
1. **Generate OTP**
   - Follow the instructions in the [Generate OTP script](https://github.com/trade-smart/TradesmartApi-java/blob/master/src/main/java/com/kspl/norenexampleapp/NorenExampleApp.java#L35).

2. **Use OTP for Login**
   - Use the generated OTP as `factor2` in the login process.
   - Refer to the [Login script](https://github.com/trade-smart/TradesmartApi-java/blob/master/src/main/java/com/kspl/norenexampleapp/NorenExampleApp.java#L29) for implementation details.
